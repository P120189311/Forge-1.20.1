...
public class IncantationCategory implements IRecipeCategory<MysteryStandRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(ExampleMod.MOD_ID, "incantation");
    public static final ResourceLocation TEXTURE = new ResourceLocation(ExampleMod.MOD_ID, "textures/gui/mystery_stand_incantation_gui.png");
    ...
    public IncantationCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.MYSTERY_STAND.get()));
    }
    ...
    public Component getTitle() {
        return Component.translatable("block.examplemod.mystery_stand");
    }
