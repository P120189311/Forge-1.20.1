...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.ABSOLUTE_BLACK_HELMET);
        trimmedArmorItem(ModItems.ABSOLUTE_BLACK_CHESTPLATE);
        trimmedArmorItem(ModItems.ABSOLUTE_BLACK_LEGGINGS);
        trimmedArmorItem(ModItems.ABSOLUTE_BLACK_BOOTS);
        trimmedArmorItem(ModItems.ABSOLUTE_WHITE_HELMET);
        trimmedArmorItem(ModItems.ABSOLUTE_WHITE_CHESTPLATE);
        trimmedArmorItem(ModItems.ABSOLUTE_WHITE_LEGGINGS);
        trimmedArmorItem(ModItems.ABSOLUTE_WHITE_BOOTS);
    }
