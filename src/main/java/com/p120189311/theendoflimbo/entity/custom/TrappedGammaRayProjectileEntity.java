...
public class TrappedGammaRayProjectileEntity extends ThrowableItemProjectile {
    ...
    public TrappedGammaRayProjectileEntity(Level pLevel) {
        super(TheEndOfLimboEntities.TRAPPED_GAMMA_RAY.get(), pLevel);
    }


    public TrappedGammaRayProjectileEntity(Level pLevel, LivingEntity livingEntity) {
        super(TheEndOfLimboEntities.TRAPPED_GAMMA_RAY.get(), livingEntity, pLevel);
    }

    @Override
    protected Item getDefaultItem() {
        return TheEndOfLimboItems.TRAPPED_GAMMA_RAY.get();
    }

    public TrappedGammaRayProjectileEntity(Level level, double x, double y, double z) {
        super(TheEndOfLimboEntities.TRAPPED_GAMMA_RAY.get(), x, y, z, level);
    }
        ...
        return !(
                // Stone & natural rock types
                        ...
                        state.is(BlockTags.REDSTONE_ORES) ||
                                ...
                                // Custom Blocks
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK_ORE.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK_STAIRS.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK_SLAB.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK_FENCE.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK_FENCE_GATE.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK_WALL.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE_ORE.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE_STAIRS.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE_SLAB.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE_FENCE.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE_FENCE_GATE.get()) ||
                                state.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE_WALL.get()) ||
                                state.is(TheEndOfLimboBlocks.JUMPY_BLOCK.get())
