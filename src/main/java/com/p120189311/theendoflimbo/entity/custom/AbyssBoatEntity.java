...
public class AbyssBoatEntity extends Boat {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE = SynchedEntityData.defineId(Boat.class, EntityDataSerializers.INT);

    public AbyssBoatEntity(EntityType<? extends Boat> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public AbyssBoatEntity(Level level, double pX, double pY, double pZ) {
        this(TheEndOfLimboEntities.MOD_BOAT.get(), level);
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case ABYSS -> TheEndOfLimboItems.ABYSS_BOAT.get();
        };
    }
    ...
    public static enum Type implements StringRepresentable {
        ABYSS(TheEndOfLimboBlocks.ABYSS_PLANKS.get(), "abyss");

        private final String name;
        private final Block planks;
        public static final StringRepresentable.EnumCodec<AbyssBoatEntity.Type> CODEC = StringRepresentable.fromEnum(AbyssBoatEntity.Type::values);
        private static final IntFunction<AbyssBoatEntity.Type> BY_ID = ByIdMap.continuous(Enum::ordinal, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
        ...
        public static AbyssBoatEntity.Type byId(int pId) {
            return BY_ID.apply(pId);
        }

        public static AbyssBoatEntity.Type byName(String pName) {
