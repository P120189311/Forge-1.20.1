...
public class TheEndOfLimboBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_ABSOLUTE_BLACK_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct(placedFeatures.getOrThrow(TheEndOfLimboPlacedFeatures.ABSOLUTE_BLACK_ORE_PLACED_KEY)),
        ...
        context.register(ADD_ABSOLUTE_WHITE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(TheEndOfLimboPlacedFeatures.ABSOLUTE_WHITE_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(TheEndOfLimboMod.MAIN, name));
    }
}
