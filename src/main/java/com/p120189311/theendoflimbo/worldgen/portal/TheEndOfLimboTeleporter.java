package com.p120189311.theendoflimbo.worldgen.portal;

import com.p120189311.theendoflimbo.block.TheEndOfLimboBlocks;
import com.p120189311.theendoflimbo.block.custom.AbyssPortalBlock;
...
public class TheEndOfLimboTeleporter implements ITeleporter {
    public static BlockPos thisPos = BlockPos.ZERO;
    public static boolean insideDimension = true;

    public TheEndOfLimboTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, TheEndOfLimboBlocks.ABYSS_PORTAL.get().defaultBlockState(), 3);
            }
        }
