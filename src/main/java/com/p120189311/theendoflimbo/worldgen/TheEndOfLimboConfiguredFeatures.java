...
public class TheEndOfLimboConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldAbsoluteBlackOres = List.of(OreConfiguration.target(stoneReplaceable,
                TheEndOfLimboBlocks.ABSOLUTE_BLACK_ORE.get().defaultBlockState())
        ...
        List<OreConfiguration.TargetBlockState> overworldAbsoluteWhiteOres = List.of(OreConfiguration.target(stoneReplaceable,
                TheEndOfLimboBlocks.ABSOLUTE_WHITE_ORE.get().defaultBlockState())
        ...
        register(context, ABYSS_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(TheEndOfLimboBlocks.ABYSS_LOG.get()),
                new AbyssTrunkPlacer(10,5,5),

                BlockStateProvider.simple(TheEndOfLimboBlocks.ABYSS_LEAVES.get()),
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(TheEndOfLimboMod.MAIN, name));
    }
