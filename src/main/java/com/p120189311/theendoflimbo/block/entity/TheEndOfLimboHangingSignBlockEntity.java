...
public class TheEndOfLimboHangingSignBlockEntity extends SignBlockEntity {
    public TheEndOfLimboHangingSignBlockEntity(BlockPos p_155700_, BlockState p_155701_) {
        super(TheEndOfLimboBlockEntities.MOD_HANGING_SIGN.get(), p_155700_, p_155701_);
    }

    @Override
    public BlockEntityType<?> getType() {
        return TheEndOfLimboBlockEntities.MOD_HANGING_SIGN.get();
    }
