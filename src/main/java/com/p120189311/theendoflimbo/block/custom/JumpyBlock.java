    ...
    */
    ...
    public void appendHoverText(ItemStack p_49816_, @Nullable BlockGetter p_49817_, List<Component> pTooltipComponents, TooltipFlag p_49819_) {
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("tooltip.theendoflimbo.jumpy_block.tooltip.shift"));
        } else {
            pTooltipComponents.add(Component.translatable("tooltip.theendoflimbo.jumpy_block.tooltip"));
        }
    }
    ...
    public void stepOn(Level level, BlockPos pos, BlockState state, Entity entity) {
        if(entity instanceof LivingEntity livingEntity) {
            livingEntity.addEffect(new MobEffectInstance(MobEffects.JUMP,40,3));
        }
