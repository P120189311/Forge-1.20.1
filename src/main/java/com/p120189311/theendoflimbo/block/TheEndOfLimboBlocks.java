package com.p120189311.theendoflimbo.block;
...
public class TheEndOfLimboBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, TheEndOfLimboMod.MAIN);
    ...
    public static final RegistryObject<Block> ABYSS_LOG = registerBlock("abyss_log",
            () -> new AbyssFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)
                    .strength(6f)
                    .requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> ABYSS_WOOD = registerBlock("abyss_wood",
            () -> new AbyssFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD)
                    .strength(6f)
                    .requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> STRIPPED_ABYSS_LOG = registerBlock("stripped_abyss_log",
            () -> new AbyssFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_DARK_OAK_LOG)
                    .strength(6f)
                    .requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> STRIPPED_ABYSS_WOOD = registerBlock("stripped_abyss_wood",
            () -> new AbyssFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_DARK_OAK_WOOD)
                    .strength(6f)
                    .requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> ABYSS_PLANKS = registerBlock("abyss_planks",
            () -> new AbyssPlanks(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)
                    .strength(4f)
                    .requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> ABYSS_LEAVES = registerBlock("abyss_leaves",
            () -> new AbyssLeavesBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_LEAVES)));
    ...
    public static final RegistryObject<Block> POTTED_ABYSS_SAPLING = registerBlock("potted_abyss_sapling",
            () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, TheEndOfLimboBlocks.ABYSS_SAPLING,
    ...
    public static final RegistryObject<Block> ABYSS_SIGN = BLOCKS.register("abyss_sign",
            () -> new AbyssStandingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), TheEndOfLimboWoodTypes.ABYSS));
    public static final RegistryObject<Block> ABYSS_WALL_SIGN = BLOCKS.register("abyss_wall_sign",
            () -> new AbyssWallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_SIGN), TheEndOfLimboWoodTypes.ABYSS));

    public static final RegistryObject<Block> ABYSS_HANGING_SIGN = BLOCKS.register("abyss_hanging_sign",
            () -> new AbyssHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_HANGING_SIGN), TheEndOfLimboWoodTypes.ABYSS));
    ...
    public static final RegistryObject<Block> POTTED_DECAYING_HARMONY = BLOCKS.register("potted_decaying_harmony",
            () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, TheEndOfLimboBlocks.DECAYING_HARMONY,
                    BlockBehaviour.Properties.copy(Blocks.POTTED_WITHER_ROSE).noOcclusion()));
    ...
    public static final RegistryObject<Block> ABSOLUTE_BLACK_STAIRS = registerBlock("absolute_black_stairs",
            () -> new StairBlock(() -> TheEndOfLimboBlocks.ABSOLUTE_BLACK.get().defaultBlockState(),
    ...
    public static final RegistryObject<Block> ABSOLUTE_WHITE_STAIRS = registerBlock("absolute_white_stairs",
            () -> new StairBlock(() -> TheEndOfLimboBlocks.ABSOLUTE_WHITE.get().defaultBlockState(),
                    BlockBehaviour.Properties.of()
                            .mapColor(MapColor.METAL)
                    .strength(5f)
                    .requiresCorrectToolForDrops()));
    ...
    private static <T extends Block> RegistryObject<Item> registerBlockItem(String name, RegistryObject<T> block) {
        return TheEndOfLimboItems.ITEMS.register(name, () -> new BlockItem(block.get(),
                new Item.Properties()));
    }
