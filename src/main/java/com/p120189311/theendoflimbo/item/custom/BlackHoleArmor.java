...
public class BlackHoleArmor extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(TheEndOfLimboArmorMaterials.ABSOLUTE_BLACK,
    ...
    private static boolean isWearingFullBlackSet(Player player) {
        ...
        return boots.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_BLACK
                && leggings.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_BLACK
                && chestplate.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_BLACK
                && helmet.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_BLACK;
    }
