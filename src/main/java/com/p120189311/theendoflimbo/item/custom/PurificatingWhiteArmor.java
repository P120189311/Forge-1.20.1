...
import com.p120189311.theendoflimbo.item.TheEndOfLimboArmorMaterials;
...
public class PurificatingWhiteArmor extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
        (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                .put(TheEndOfLimboArmorMaterials.ABSOLUTE_WHITE,
    ...
    private static boolean isWearingFullWhiteSet(Player player) {
        ...
        return boots.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_WHITE
                && leggings.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_WHITE
                && chestplate.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_WHITE
                && helmet.getMaterial() == TheEndOfLimboArmorMaterials.ABSOLUTE_WHITE;
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.theendoflimbo.purificating_white_armor").withStyle(ChatFormatting.WHITE).withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.BOLD));
    }
}
