...
public class InfectiousBlackPickaxe extends PickaxeItem {
    ...
    private Block getOffhandBlock(Player player) {
        ...
        if (offhand.is(TheEndOfLimboBlocks.ABSOLUTE_BLACK_ORE.get().asItem())) {
            return TheEndOfLimboBlocks.ABSOLUTE_BLACK_ORE.get();
        }
        if (offhand.is(TheEndOfLimboBlocks.ABSOLUTE_WHITE_ORE.get().asItem())) {
            return TheEndOfLimboBlocks.ABSOLUTE_WHITE_ORE.get();
        }
        return null;
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.theendoflimbo.infectious_black_pickaxe").withStyle(ChatFormatting.DARK_GRAY).withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.BOLD));
    }
}
