package com.p120189311.theendoflimbo.loot;
...
public class TheEndOfLimboLootModifiers {
    public static final DeferredRegister<Codec<? extends IGlobalLootModifier>> LOOT_MODIFIER_SERIALIZERS =
            DeferredRegister.create(ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, TheEndOfLimboMod.MAIN);
